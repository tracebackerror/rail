...
const LogInPage = () => {
    ...
    function LogIn() {
        ...
        Cookies.set('is_admin', 'value');
        // {Cookies.get('username') ? Cookies.get('username'): 0}
        history(`/`);
    }
    ...
    return (<>
        <div class="flex flex-col items-center justify-center w-screen h-screen bg-gray-200 text-gray-700">
            <form class="flex flex-col bg-white rounded shadow-lg p-12 mt-12" action="">
                ...
                <button onClick={LogIn} class="flex items-center justify-center h-12 px-6 w-64 bg-blue-600 mt-8 rounded font-semibold text-sm text-blue-100 hover:bg-blue-700">Login</button>
